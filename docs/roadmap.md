...
- Build to [design-system.md](design/design-system.md) — colour roles, type scale, component specs and the required states are settled there. Resolve **G1–G4** in *Feature gaps* below first, or drop the elements that depend on them.

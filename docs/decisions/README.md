...
| [013](013-scala-orchestrator.md) | Stateful Scala orchestrator for parallel dispatch | accepted | Hand-started dispatcher (cap 10, failover, conflict rebase); adds `## TDD evidence` and docs-only conditions to auto-merge |

...
| [010](010-unattended-dispatch-and-auto-merge.md) | Unattended dispatch and auto-merge | accepted, amended by [012](012-drop-the-no-mistakes-gate.md) | Hourly Orca automation starts `ready`, unblocked sub-issues; auto-merge only on a green Tests gate and CI |
